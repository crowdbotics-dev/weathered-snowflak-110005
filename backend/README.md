...
## Project Structure
    ...
    ├── weathered_snowflak_110005  # Django project configurations
...
1. Clone this repo and `cd weathered_snowflak_110005`
...
2. Clone this repo and `cd weathered_snowflak_110005`
